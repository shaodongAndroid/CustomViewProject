package com.custom.view.project.progress;
...
public class FlikerProgressActivity extends AppCompatActivity implements View.OnClickListener, Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fliker_progress);
