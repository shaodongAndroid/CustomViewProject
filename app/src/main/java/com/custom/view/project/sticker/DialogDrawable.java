...
public class DialogDrawable extends Drawable {
    ...
    public DialogDrawable() {
        ...
        Log.d(TAG, "DialogDrawable: getIntrinsicWidth = "+getIntrinsicWidth());
        Log.d(TAG, "DialogDrawable: getIntrinsicHeight = "+getIntrinsicHeight());
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        Log.d(TAG, "setBounds: top = "+top);
        Log.d(TAG, "setBounds: bottom = "+bottom);
        if (mRectF == null) {
