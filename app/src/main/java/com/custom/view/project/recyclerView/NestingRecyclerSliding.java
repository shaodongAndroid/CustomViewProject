...
public class NestingRecyclerSliding implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    ...
    private int bgWidth = 1 ; // 1 and not 0 to prevent dividing by zero //, bgWidthLeft = 1
...
//    private int mDismissAnimationRefCount = 0;
    ...
    private NestingRecyclerSliding() {
    }

    public NestingRecyclerSliding(Activity a, RecyclerView recyclerView) {
        this.mActivity = a;
...
//        mSwipeListener = listener;
    ...
    public NestingRecyclerSliding setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public NestingRecyclerSliding setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public NestingRecyclerSliding setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
    }
    public NestingRecyclerSliding setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public NestingRecyclerSliding setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public NestingRecyclerSliding setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public NestingRecyclerSliding setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    public NestingRecyclerSliding setSwipeable(boolean value) {
    ...
    public NestingRecyclerSliding setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public NestingRecyclerSliding setUnSwipeableRows(Integer... rows) {
    ...
    public void openSwipeOptions(int position) {
        if (!swipeable || recyclerView.getChildAt(position) == null
        ...
        touchedView = recyclerView.getChildAt(position);
...
//                        if ((Math.abs(translateAmount) > bgWidth ? -bgWidth : translateAmount) <= 0) {
                        ...
                        if (Math.abs(translateAmount) > bgWidth) fgView.setTranslationX(-bgWidth);
                        else fgView.setTranslationX(translateAmount);
