package com.custom.view.project.Launch;
...
import com.custom.view.project.util.Utils;
...
//        ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, View.SCALE_X, 1, getScale(target), 1.0f);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, "scaleX", 1, getScale(target), 1.0f);
//        ObjectAnimator scaleY = ObjectAnimator.ofFloat(target, View.SCALE_Y, 1, getScale(target), 1.0f);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(target, "scaleY", 1, getScale(target), 1.0f);
...
//                ObjectAnimator alpha = ObjectAnimator.ofFloat(slogo, View.ALPHA, 0f, 1f);
                ObjectAnimator alpha = ObjectAnimator.ofFloat(slogo, "alpha", 0f, 1f);
