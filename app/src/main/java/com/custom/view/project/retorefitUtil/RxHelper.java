package com.custom.view.project.retorefitUtil;
...
public class RxHelper {
    ...
    public static <T>Observable<T> load(Context context, String cacheKey, long expireTime, Observable<T> fromeNetwork, boolean forceRefresh){
